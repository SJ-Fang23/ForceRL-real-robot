...
class GetRobotFrameGrasp:
    ...
    def transform_to_robot_frame(self):
        ...
        while not rospy.is_shutdown():
            ...
            listener.waitForTransform("right_base", "camera_depth_optical_frame", rospy.Time(0), rospy.Duration(10.0))
            (trans, rot) = listener.lookupTransform("right_base", "camera_depth_optical_frame", rospy.Time(0))
    ...
    def visualize_grasp(self, point):
        ...
        # set marker
        marker = Marker()
        marker.header.frame_id = "right_base"
